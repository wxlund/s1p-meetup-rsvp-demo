...
package org.springframework.cloud.stream.app.test.meetup.rsvp;
...
/**
 * Adds a mock {@link RestTemplate} to enable contextLoads() tests
 * to run successfully.
 *
 * @author Gary Russell
 *
 */
@Configuration
public class MeetupRsvpTestConfiguration {
